...
public class Configuracion {
    ...
    @Element public static String DatabaseUser;

    @Element public static String DatabasePass;

    @Element public static String URL;

    @Element public static String MailConfigFrom;

    @Element(name="EmailEmergencia") public static String MailConfigTo;

    @Element public static String MailConfigUser;

    @Element public static String MailConfigPass;
